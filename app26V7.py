...
APP_VERSION = "v7 · project allocation & variance · 2026-06-26"
...
PROJECTS = ["Roadmap", "C&I", "Support"]   # C&I = Customization & Integration
...
SPLIT_COLUMNS = ["Team", "Roadmap", "C&I", "Support"]
AGREED_COLUMNS = ["Category", "Month", "Agreed"]

# Default per-team split (%) from the project-division screenshot. QA is a
# blended placeholder (its data splits into QA-Development / QA-Stability) and
# Fix defaults to 100% Roadmap — both editable in-app.
SPLIT_SEED = [
...
tab_team, tab_hol, tab_proj, tab_forecast = st.tabs(
...
with tab_proj:
    ...
    # Flag any team whose split does not total 100%.
    bad = [r["Team"] for _, r in split_df.iterrows()
           if abs(r["Roadmap"] + r["C&I"] + r["Support"] - 100) > 0.01]
    if bad:
